...
export const TimelineHeader = memo(function TimelineHeader({
  ...
  const { zoomConfig, viewStart, viewEnd, zoom, locale } = useGanttContext();
      ...
      <div className={styles.headerRow}>
        ...
        >
          {secondaryCells.map((cell) => (
            <div
              key={cell.key}
              className={`${styles.headerCell} ${styles.headerCellSecondary} ${cell.isWeekend ? styles.headerCellWeekend : ''}`}
              style={{
                position: 'absolute',
                left: cell.left,
                width: cell.width,
